declare module './fs-ops.mjs' {
  ...
  export function moveWithCollision(from: string, toDir: string, options?: MoveOptions): Promise<string>
  export function dirSizeBytes(dir: string): Promise<number>
  export function renameWithCollision(from: string, newName: string, options?: MoveOptions): Promise<string>
